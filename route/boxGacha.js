...
const boxGacha = require("../mongoose/boxModel");
...
app.post("/boxGacha", hostAuth, async (req, res) => {
  //   console.log("success");

  let resStatus = 200;
  let resMessage = "Success";

  let _bronzeBox = req.body.bronzeBox || "";
  let _silverBox = req.body.silverBox || "";
  let _goldBox = req.body.goldBox || "";

  if (_bronzeBox === "" || _silverBox === "") {
    resStatus = 400;
